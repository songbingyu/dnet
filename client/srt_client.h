// File: client/srt_client.h
//
// Description: Defines client state constants, client-side data structures,
// and the client SRT socket interfaces.
//
...
/* Global Client TCB table array that holds a TCB table for each client-server connection */
client_tcb_t * connectionList [MAX_TRANSPORT_CONNECTIONS];

/* Actual socket file descriptor created in overlay_start that contains the tcp connection with the app_server */
int sockConnGlobal;
